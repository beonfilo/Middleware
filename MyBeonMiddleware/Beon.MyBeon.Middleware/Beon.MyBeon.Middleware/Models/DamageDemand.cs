...
namespace Beon.MyBeon.Middleware.Models
{
	public class DamageDemand : BaseModel
	{
		...
		public double ExemptionTotal;

		public double DefectRate { get; set; } =default; // kusur oranı
		public string DamageCause { get; set; } = string.Empty;
		public DateTime DamageDate { get; set; } = DateTime.Now; //hasar tarihi
		public TimeSpan DamageTime { get; set; } = default; //hasar saati
		...
		public DateTime EstimatedDeliveryDate { get; set; } = DateTime.Now; //tahmini teslim tarihi
